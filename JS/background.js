...
function Background(game,player) {
    ...
    this.hurdles.src = "images/hurdles-2.png"
}


//draw para pintar la primera vez sino hago draw2 pierdo imagen de fondo
Background.prototype.draw = function () {
    this.hurdles.onload = function () {//pongo penultima imagen.onload para que me cargue todas....sino falla
        this.draw2();
        // this.player.draw()
    }.bind(this);
};
...
Background.prototype.draw2 = function () {
    for(i=0; i<13 ;i++){           
        ...
        this.game.ctx.drawImage(this.hurdles, this.positionFrame+1000, 569, 80, 194);
        this.moveFrame();
        // this.player.draw()
};
